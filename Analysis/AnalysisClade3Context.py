...
os.chdir('/Users/u1866168/Documents/OneDrive - University of Warwick/MHC_Scripts/Cyanobacteria/Python_results/')
# This will read the dictionary created during the extraction and translation into clusters of the different locustag
Dictionary1 = open("/Users/u1866168/Documents/OneDrive - University of "
...
with open('/Users/u1866168/Documents/OneDrive - University of '
          'Warwick/Experiments/Experiments_Python/UnknownCya_Clade3_NoStrict.csv', newline='') as genecontext:
    Context = list(csv.reader(genecontext))

ClusterUnkContext = csv.writer(
    open("/Users/u1866168/Documents/OneDrive - University of "
         "Warwick/MHC_Scripts/Cyanobacteria/Python_results/ClusterUnkCladeIIIContext.csv", "w"))
...
with open('/Users/u1866168/Documents/OneDrive - University of '
          'Warwick/MHC_Scripts/Cyanobacteria/Python_results/ClusterUnkCladeIIIContext.csv', newline='') as genecontext:
    ContextLocus = list(csv.reader(genecontext))  # Reading of the csv already created

UnkContextPattern = csv.writer(
    open("/Users/u1866168/Documents/OneDrive - University of "
         "Warwick/MHC_Scripts/Cyanobacteria/Python_results/ClusterUnkContextCladeIIIPatterns.csv", "w"))
