...
for index, row in Trancript_database.iterrows():  # Creation of dictionary and further dataframe for the CSV file
    ...
    if key not in temporal_dict:
        addition = {key: [row['AMT22_18_18_CT.txt.TPM'], row['AMT22_3_4_CT.TPM'], row['AMT22_53_53_CT.TPM'],
                          row['AMT22_75_75_CT.TPM'], row['AMT22_75_75_SS.TPM'], row['AMT22_CTD4.TPM'],
                          row['AMT22_CTD75.txt.TPM'], row['AMT23_11_15_CT.TPM'], row['AMT23_11_15_DS.TPM'],
                          row['AMT23_37_46_CT.TPM'], row['AMT23_37_46_DS.TPM'], row['AMT23_39_49_DS.TPM'],
                          row['AMT23_3_5_CT.txt.TPM'], row['AMT23_3_5_DS.TPM'], row['AMT23_54_65_CT.TPM'],
                          row['AMT23_54_65_DS.TPM']]}
        temporal_dict.update(addition)
    else:
        addition = {
            key: [temporal_dict[key][0] + row['AMT22_18_18_CT.txt.TPM'], temporal_dict[key][1] + row['AMT22_3_4_CT.TPM'],
                  ...
                  temporal_dict[key][6] + row['AMT22_CTD75.txt.TPM'], temporal_dict[key][7] + row['AMT23_11_15_CT.TPM'],
                  ...
                  temporal_dict[key][12] + row['AMT23_3_5_CT.txt.TPM'], temporal_dict[key][13] + row['AMT23_3_5_DS.TPM'],
